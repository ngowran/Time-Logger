...
SECRET_KEY = 'django-insecure-2*0hh!k#83j+x&kxs#*lok5_z3sx*)ufhb6_7hjc%a30tqzc7&'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
          os.path.join(BASE_DIR, "timelogger/frontend/build")
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
  os.path.join(BASE_DIR, "timelogger/frontend/build/static"),
]
